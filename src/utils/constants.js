export const popupButtonProfile = document.querySelector ('.profile__button_type_user');
export const popupButtonPlace = document.querySelector ('.profile__button_type_place');
